                    ...
                    <div>
                        <Box margin="auto">
                            <Paper
                                ...
                                <audio id='a1' className="audio-element" onPause={() => pauseAudio(0)}>
                                    <source
                    ...
                    <div>
                        <Box margin="auto">
                            <Paper
                                ...
                                <img src="https://27mi124bz6zg1hqy6n192jkb-wpengine.netdna-ssl.com/wp-content/uploads/2019/10/Our-Top-10-Songs-About-School-768x569.png"></img>
                                <audio id='a2' className="audio-element" onPause={() => pauseAudio(1)}>
                                    <source
                                ...
                                <div class="flex flex-row ml-2 mr-2">
                                    ...
                                    <button id="b11" className="flex bg-pink-600 text-white py-2 px-6 rounded mt-3 mb-3 ml-2" onClick={() => pauseAudio(1)}>STOP</button>
                                </div>
                            </Paper>
                        </Box>
                    </div>
                    <div>
                        <Box margin="auto">
                            <Paper
                                ...
                                <img src="https://27mi124bz6zg1hqy6n192jkb-wpengine.netdna-ssl.com/wp-content/uploads/2019/10/Our-Top-10-Songs-About-School-768x569.png"></img>
                                <audio id='a3' className="audio-element" onPause={() => pauseAudio(2)}>
                                    <source
                                ...
                                <div class="flex flex-row ml-2 mr-2">
                                    ...
                                    <button id="b21" className="flex bg-pink-600 text-white py-2 px-6 rounded mt-3 mb-3 ml-2" onClick={() => pauseAudio(2)}>STOP</button>
                                </div>
                            </Paper>
                        </Box>
                    </div>
